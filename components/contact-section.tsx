      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-white/70 leading-relaxed mb-6">
                Ready to create solutions that prioritize user experience and remove unnecessary complexity? I'm always
                interested in discussing innovative projects and opportunities.
              </p>
              <p className="text-white/70 leading-relaxed">
                Whether it's a mobile app, web platform, or performance optimization challenge, let's explore how we can
          ...
          <Card className="bg-black/80 backdrop-filter backdrop-blur-20 border-white/20">
            <CardContent className="p-8 space-y-6">
              <div className="text-center mb-8">
                <h4 className="text-xl font-mono font-bold text-white mb-2">Get In Touch</h4>
                <p className="text-white/70 text-sm">Choose your preferred method</p>
              </div>

              <div className="space-y-4">
                <Button size="lg" className="w-full font-mono bg-white text-black hover:bg-white/90 glow-accent">
              ...
              <div className="pt-6 border-t border-white/20 text-center">
                <p className="text-white/50 font-mono text-xs tracking-wider">RESPONSE TIME: 24 HOURS</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-black/80 backdrop-filter backdrop-blur-20 border-white/20 rounded-full">
            ...
            <span className="text-white font-mono text-sm tracking-wide">AVAILABLE FOR NEW PROJECTS</span>
          </div>
        </div>
      </div>
    </section>
